...
?>
          ...
          <br />
            ...
            {
            	echo "<option value='" . $x . "'";
              if($eventDate['hour'] == $x) echo " selected";
              echo ">" . $x . "</option>";
            }            	
            ?>
  				</select>
            ...
            for($x = 0; $x <= 9; $x++)
            {
              ...
              if($eventDate['minute'] == $x) echo " selected";
              echo ">0" . $x . "</option>";
            }            	
            for($x = 10; $x <= 59; $x++)
            {
          ...
          <select name="meridiem">
						<option value='am'<?php if($eventDate['meridiem'] == "am") echo " selected"; ?>>am</option>
            <option value='pm'<?php if($eventDate['meridiem'] == "pm") echo " selected"; ?>>pm</option>          
          </select>
  			</td>
      </tr>